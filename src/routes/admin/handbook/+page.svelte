	...
	<div class="path">
		<div class="path-card main">
			...
			<ol>
				...
				<li>結帳時把這組碼填進<b>「狗狗幣備註碼」那一題</b>（賣貨便）或<b>贊助者留言</b>（綠界）</li>
...
3. 結帳時把這組碼貼進「狗狗幣備註碼」欄位（綠界則填在「贊助者留言」）
...
<div class="panel">
	...
	<ol class="steps">
		<li>
			<b>從平台匯出訂單，存成 CSV</b><br />
			<b>賣貨便</b>匯出的是 Excel 檔（.xlsx），用 Excel 或 Google 試算表打開後「另存為 CSV」。
			<b>綠界</b>直接匯出 CSV。兩種都<u>不用刪欄位、不用調整格式</u>。
		</li>
		<li>
			<b>到<a href="/admin/coins">狗狗幣發放</a>，選擇這個 CSV 檔</b><br />
			系統會自動分辨是賣貨便還是綠界，不需要設定欄位位置。
			綠界的代碼看<b>贊助者留言</b>，賣貨便看<b>「狗狗幣備註碼」那一題</b>。
		</li>
		<li>
			<b>按「預覽比對結果」</b><br />
